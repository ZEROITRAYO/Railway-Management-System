...
CREATE TABLE `time_table` (
  ...
  CONSTRAINT `time_table_ibfk_1` FOREIGN KEY (`train_id`) REFERENCES `train` (`train_id`)
);


CREATE TABLE `train_time_changed` (
  `train_id` varchar(6) NOT NULL,
  `date_of_journey` date NOT NULL,
  `arrival` time DEFAULT NULL,
  ...
  PRIMARY KEY (`train_id`,`date_of_journey`,`date_changed`,`time_changed`),
  CONSTRAINT `train_time_changed_ibfk_1` FOREIGN KEY (`train_id`, `date_of_journey`) REFERENCES `time_table` (`train_id`, `date_of_journey`)
);
